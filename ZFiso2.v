...
Require Import basic ZF2 ZFpairs2 ZFrelations2 ZFsum2.
...
Module IZF_FR_Thms_ZFiso (Import IZF : (IZF_FR_sig CoqSublogicThms)).
Include (IZF_FR_Thms_ZFsum IZF).
Module IZF_FR_Thms_ZFrelations := (IZF_FR_Thms_ZFrelations IZF).
Export IZF_FR_Thms_ZFrelations.
...
(*  unfold TIF_iso. *)
(*  apply REC_ord_irrel with (1:=oo) (2:=TIF_iso_recursor); trivial. *)
(*   reflexivity. *)
