...
Require Import ZFpairs2.
Require Import ZFstable2.

Module IZF_FR_Thms_ZFsum (Import IZF : (IZF_FR_sig CoqSublogicThms)).
Include (IZF_FR_Thms_ZFpairs IZF).
