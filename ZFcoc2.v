...
Require Export basic ZF2 ZFpairs2 ZFrelations2 ZFstable2.
Require Export ZFiso2.
(* Require Import ZFgrothendieck.*)

Module IZF_FR_Thms_ZFcoc (Import IZF : (IZF_FR_sig CoqSublogicThms)).
Include (IZF_FR_Thms_ZFiso IZF).
